...
export declare interface BaseFrameProps {
    /* Excluded from this release type: constraints */
    /**
...
/** @public */
export declare interface FrameProps extends BackgroundProperties, VisualProperties, Omit<MotionDivProps, "color">, CSSTransformProperties, LayerProps, LayoutProperties, ShortcutsProperties, BaseFrameProps {
}
...
declare class Layer<P extends Partial<LayerProps>, S> extends React.Component<P, S> {
    ...
    static applyWillChange<P extends Partial<LayerProps>>(layer: {
        props: P;
 ...
 * @public
 * */
export declare interface LayoutProperties {
    /**
...
/** @public */
export declare type Override<T extends object = DeprecatedFrameWithEventsProps & {
    [key: string]: any;
...
export declare interface ScrollConfig {
     ...
     * <Scroll scrollAnimation={animation} />
     * ```
     * @beta
     * */
    scrollAnimation?: AnimationControls;
 ...
 * @public
 * */
export declare interface ShortcutsProperties {
    /**
 ...
 * @public
 */
export declare interface StackProperties extends StackSpecificProps, FrameProps {
